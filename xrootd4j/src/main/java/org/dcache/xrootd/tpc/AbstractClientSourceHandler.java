 ...
 *
 * This handler implements open and close.</p>
 *
 * Concrete implementations must handle the actual read and checksum
 *    requests and responses.</p>
 *
 * If the close response is OK, it hands it off to the next handler
 *    in the chain.</p>
 */
